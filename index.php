...
<body style="background-color: gray;">
    <div class="container mt-5">
        ...
        <!-- Modal -->
        <div class="modal fade" id="tambahmahasiswa" tabindex="-1" aria-labelledby="tambah mahasiswa"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="tambahmahasiswaLabel">Modal title</h1>
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo baseurl("aksi.php") ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="asal" aria-describedby="emailHelp"
                                    name="asal">
                            </div>
                            <br>
                        ...
                        <tr>
                            ...
                            <td>
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="<?php echo baseurl("aksi.php") ?>">
                                                    <input type="hidden" class="form-control" id="id"
                                                        aria-describedby="emailHelp" value="<?php echo $row["id"]; ?>"
                                                        name="id">
                                                    <div class="mb-3">
                                                        <label for="nama" class=" form-label">Nama Mahasiswa</label>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="asal"
                                                            aria-describedby="emailHelp" value="<?php echo $row["asal"]; ?>"
                                                            name="asal">
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" name="edit-user">Save
                                                            changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#hapus<?php echo $row["id"]; ?>">
                                    Hapus
                                </button>

                                <!-- Modal -->
                                <div class="modal fade" id="hapus<?php echo $row["id"]; ?>" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
        ...
        <br>
        <h3 align="center"> data kosong</h3>
            <?php
                }
                ?>
            </tbody>
